...
const features: { icon: typeof ListChecks; title: string; desc: string }[] = [
  ...
  },
  {
    icon: Swords,
    title: "경기장 — 시뮬 대결",
    desc: "내 팀으로 친구·다른 사용자 팀과 9이닝 가상 대결. 친구 대결(4자리 초대 코드), 출전 팀 도전, AI 자동 생성 라인업 중에서 선택."
  },
  {
    icon: History,
    title: "내 기록 & 리플레이",
...
const faqs: Faq[] = [
  ...
  {
    q: "AI 대결도 내 기록에 남나요?",
    a: "친구 대결과 출전 팀 매칭만 기록에 저장됩니다. AI(자동 생성) 라인업과의 대결은 연습용이라 저장되지 않아요."
  },
  {
  ...
  {
    q: "출전 등록이 뭐예요?",
    a: "내 팀의 타자 9명과 선발 투수를 채운 뒤 '출전 등록'을 하면 다른 사용자가 경기장 → 출전 팀 목록에서 도전할 수 있어요. 필수 라인업이 부족해지면 자동으로 출전 준비 상태가 됩니다."
  },
  {
