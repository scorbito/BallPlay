-- 주간 예측왕 이벤트 2주차(7/28–8/2) 당첨자 발표 공지
--
...
--
-- 출처: bp_predict_event_draws (week_start_date = '2026-07-28')
--   예측왕 전력투구야구덕후5c7 — 21경기 14적중(67%) / AI 평균 47.4% / 자격자 9명 · 참여자 43명
--
-- ⚠️ 당첨자 연락처(이메일/휴대폰)는 공지에 노출하지 않는다(개인정보). 닉네임만.

insert into public.bp_notices (title, body, published_at)
select
  '🎉 주간 예측왕 2주차 당첨자 발표 (7/28–8/2)',
  E'안녕하세요, 야구놀이터입니다.\n\n'
